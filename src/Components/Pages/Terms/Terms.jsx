          ...
          <Card>
            <CardContent>
              ...
              <ul>
                ...
                <li>
                  <Typography variant="body1">
                    <strong>Website</strong> refers to naxatranewshindi,
                    accessible from{" "}
                    <Link href="https://naxatranewshindi.com/" target="_blank">
                      https://naxatranewshindi.com/
                    </Link>
                  </Typography>
                </li>
                <li>
              ...
              <ul>
                <li>
                  <Typography variant="body1">
                    By email: info@naxatranewshindi.com
                  </Typography>
                </li>
                <li>
                  <Typography variant="body1">
                    By phone number: +91-8271776646
                  </Typography>
                </li>
